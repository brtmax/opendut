...
impl Resources<'_> {
    ...
    pub async fn create_cluster_configuration(&mut self, params: CreateClusterConfigurationParams) -> Result<ClusterId, CreateClusterConfigurationError> {
        ...
        self.insert(cluster_id, params.cluster_configuration).await
